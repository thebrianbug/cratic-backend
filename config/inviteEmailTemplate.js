var template = function(department) {
	var userEmail = `
	...
	<body style="box-sizing: border-box;margin: 0;font-family: -apple-system,BlinkMacSystemFont,&quot;Segoe UI&quot;,Roboto,&quot;Helvetica Neue&quot;,Arial,sans-serif,&quot;Apple Color Emoji&quot;,&quot;Segoe UI Emoji&quot;,&quot;Segoe UI Symbol&quot;;font-size: 1rem;font-weight: 400;line-height: 1.5;color: #212529;text-align: left;background-color: #fff;min-width: 992px!important;">
			...
			<div class="jumbotron" style="box-sizing: border-box;padding: 2rem 2rem;margin-bottom: 2rem;background-color: #2E303C;border-radius: 0;color: #f4f4f4 !important;margin: 0;">
					...
					<p style="box-sizing: border-box;color: #f4f4f4 !important;margin-top: 2rem;margin-bottom: 1rem;orphans: 3;widows: 3;">Hello!</p>
					<p style="box-sizing: border-box;color: #f4f4f4 !important;margin-top: 0;margin-bottom: 1rem;orphans: 3;widows: 3;">You have been invited to a Live Team on Cratic Ai.</p>
					<p style="box-sizing: border-box;color: #f4f4f4 !important;margin-top: 0;margin-bottom: 1rem;orphans: 3;widows: 3;">Please click the below button and register your team account.</p>
					<p style="box-sizing: border-box;color: #f4f4f4 !important;margin-top: 0;margin-bottom: 1rem;orphans: 3;widows: 3;">You will need to enter your Team Code: <strong>${department}</strong></p>
					...
					<a class="btn bg-purple" href="https://www.cratic.ai" role="button" style="box-sizing: border-box;color: #f4f4f4 !important;text-decoration: none;background-color: #57af57 !important;-webkit-text-decoration-skip: objects;display: inline-block;font-weight: 400;text-align: center;white-space: nowrap;vertical-align: middle;-webkit-user-select: none;-moz-user-select: none;-ms-user-select: none;user-select: none;border: 1px solid transparent;padding: .375rem .75rem;font-size: 1rem;line-height: 1.5;border-radius: .25rem;transition: color .15s ease-in-out,background-color .15s ease-in-out,border-color .15s ease-in-out,box-shadow .15s ease-in-out;">Register Here</a>
					</p>

					<p style="box-sizing: border-box;color: #f4f4f4 !important;margin-top: 5rem;margin-bottom: 1rem;orphans: 3;widows: 3;">Button not working? Try this link in your browser: https://www.cratic.ai</p>
